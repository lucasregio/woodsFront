    ...
    return (
      <>
        <div className="bg-gray-200">
          {/* <div className="h-screen w-5/6 ml-40  bg-gray-50">
            <div className="md:grid md:grid-cols-3 md:gap-6 ">
              <div className="md:col-span-1">
                <div className="px-4 sm:px-0">
                  <h3 className=" text-center text-lg font-medium leading-6 text-gray-900">Profile</h3>
     ...
     */}
          ...
          <div className="mt-10 sm:mt-0 h-screen w-5/6 ml-40">
            <div className="md:grid md:grid-cols-3 md:gap-6">
              <div className="md:col-span-1">
                <div className="px-4 sm:px-0">
                  <h3 className="text-center text-lg font-medium leading-6 text-gray-900">Personal Information</h3>
